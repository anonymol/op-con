...
#    def getBaseURL(self):
#        '''
#        the self is the object of the request BasePage (RequestHandler)
#        and you need to know the request where the application is hosted
#        '''
##    self.request.headers.get('host', 'no host')        #Print localhost:8080
##    wsgiref.util.request_uri(self.request.environ)     #Returns http://localhost:8080/possibleError
##    
##    http://docs.python.org/library/wsgiref.html#wsgiref.util.application_uri
##    returns the http up 'before / after the port 
